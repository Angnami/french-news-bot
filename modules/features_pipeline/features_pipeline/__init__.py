...
def initialize(logging_config_path:str='logging.yaml',env_file_path:str='.env'):
    ...
    if env_file_path is not None:
        logger.info(msg=f"Chargement des variables d'environnement à partir de {env_file_path}")
        load_dotenv(dotenv_path=env_file_path,verbose=True,override=True)


def initialize_logger(config_path:str='logging.yaml', log_dir_name:str='logs')->logging.Logger:
    """
